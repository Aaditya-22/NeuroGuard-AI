    ...
    <div className="flex flex-col items-center mt-10">
      ...
      {stage === "input" && (
        <div className="flex flex-col items-center animate-in fade-in zoom-in duration-300">
          ...
          />
          <button onClick={check} className="mt-6 bg-slate-900 hover:bg-blue-600 text-white font-bold py-4 px-10 rounded-2xl shadow-xl transition-all active:scale-95">
            Submit to AI
          </button>
        </div>
      )}
